   ...
   if (getprop("/controls/gear/brake-parking") == 0)
    {
     ...
     {
       if (getprop("/position/altitude-agl-ft") > 15)
        {
...
setlistener("gear/gear[2]/wow", func
{
  ...
  {
  if ( ( getprop("gear/gear[2]/compression-norm") > 0.28 ) and ( getprop("gear/gear[2]/rollspeed-ms") > 25)  and ( getprop("/velocities/speed-down-fps") > 2))
